...
Mailer.send = function (options, cb) {
  ...
  // Encode Subject in order to read UTF-8
  // More informations : https://ncona.com/2011/06/using-utf-8-characters-on-an-e-mail-subject/
  if (options && !_.isEmpty(options.subject)) {
    options.subject = rfc2047.encode(options.subject); // eslint-disable-line
  }
